...
def lookup_plant(plant_name: str) -> dict:
    ...
    return {
        ...
        "message": (
            ...
            "Acknowledge to the user that you don't have specific care data "
            "for this plant, and offer general guidance based on what they describe."
        ),
    }
